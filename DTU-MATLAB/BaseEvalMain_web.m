...
dataPath='E:\\2Ddataset\\dtu_data\\DTU_origin\\DTU_EVAL';
% my result path
%plyPath='F:\\KeYan\\Project\\Unsupervised_MVS\\KD-MVS\\20240620\\outputs\\test_dtu\\gipuma_pcd';
plyPath='E:\\my_project2\\outputs\\dtu\\jiayou\\pcd_fusion_plys';
% eval result path
resultsPath='E:\\my_project2\\outputs\\dtu\\jiayou\\pcd_fusion_plys\\';

method_string='mvsnet';
light_string='13'; % l3 is the setting with all lights on, l7 is randomly sampled between the 7 settings (index 0-6)
...
%UsedSets=[1 29 33 48 49 62 75 77];
UsedSets=[29 48 77];
...
for cIdx=1:length(UsedSets)
    ...
    %DataInName=[plyPath sprintf('/mvsnet%03d_13.ply',cSet)]
