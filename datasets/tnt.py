...
class TNTDataset(Dataset):
    ...
    def read_cam_file(self, filename):
        ...
        if self.interval_scale is not 1.06:
    ...
    def __getitem__(self, idx):
        ...
        for i, vid in enumerate(view_ids):
            ...
            intrinsics, extrinsics, depth_min_, depth_max_, depth_interval = self.read_cam_file(proj_mat_filename)
            ...
            if i == 0:
                ...
                if self.cam_mode == 'short_range':
                    ...
                    if depth_interval is None:
                        ...
                        depth_max = depth_interval * (self.total_depths - 0.5) + depth_min
