...
parser.add_argument('--depth_path', type=str, default='./outputs/dtu/jiayou_train_allnorf')
parser.add_argument('--data_list', type=str, default='datasets/lists/dtu/test.txt')  # test_copy
parser.add_argument('--ply_path', type=str, default='./outputs/dtu/jiayou_train_allnorf/open3d_fusion_plys')
...
def parse_cameras(path):
    ...
    f = lambda xs: list(map(lambda x: list(map(float, x.strip().split())), xs))  # NOQA
