...
parser.add_argument('--root_dir', type=str, default='/home/liyi/open_sourse_code/data/dtu-test-1200', help='root directory of dtu dataset')
parser.add_argument('--list_file', type=str, default='./datasets/lists/dtu/test.txt', help='file contains the scans list')

parser.add_argument('--depth_folder', type=str, default='./outputs/dtu/jiayou/')
parser.add_argument('--out_folder', type=str, default='fusibile_fused')
parser.add_argument('--plydir', type=str, default='./outputs/dtu/jiayou/gipuma_fusion_plys')
parser.add_argument('--quandir', type=str, default='')
parser.add_argument('--fusibile_exe_path', type=str, default='/home/liyi/fusibile/build/fusibile')
...
def probability_filter(scan_folder, prob_threshold):
    ...
    for view in range(0, 49):
        ...
        depth_map = load_pfm(init_depth_map_path)
        prob_map = load_pfm(prob_map_path)
