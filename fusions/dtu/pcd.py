...
parser.add_argument('--testpath', default='/home/liyi/open_sourse_code/data/dtu-test-1200', help='testing data dir for some scenes')
parser.add_argument('--testlist', default='datasets/lists/dtu/test_copy.txt', help='testing scene list')  # test_copy

parser.add_argument('--outdir', default='./outputs/dtu/jiayou', help='output dir')
parser.add_argument('--logdir', default='./experiment/liyi/dtu/jiayou', help='the directory to save checkpoints/logs')
parser.add_argument('--nolog', action='store_true', help='do not logging into .log file')
parser.add_argument('--plydir', default='./outputs/dtu/jiayou/pcd_fusion_plys/', help='output dir')
...
def check_geometric_consistency(depth_ref, intrinsics_ref, extrinsics_ref, depth_src, intrinsics_src, extrinsics_src):
    ...
    # depth_ref[depth_ref == 0] = 1e-4  # 这句话的作用是？[]里边是判断的词语
...
def filter_depth(pair_folder, scan_folder, out_folder, plyfilename):
    ...
    for ref_view, src_views in pair_data:
        ...
        ref_depth_est = read_pfm(os.path.join(out_folder, 'depth_est/{:0>8}.pfm'.format(ref_view)))[0]  # _prob_filtered
