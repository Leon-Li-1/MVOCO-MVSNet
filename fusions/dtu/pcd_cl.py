...
parser.add_argument('--plydir', default='./outputs/dtu/jiayou_train_allnorf/pcd_fusion_plys_cl/', help='output dir')

parser.add_argument('--num_worker', type=int, default=4, help='depth_filer worker')

parser.add_argument('--conf', type=float, default=0.3, help='prob confidence')  # 调整此值对模型生成的点的个数没有影响
...
def check_geometric_consistency(depth_ref, intrinsics_ref, extrinsics_ref, depth_src, intrinsics_src, extrinsics_src, args):
    ...
    mask = np.logical_and(dist < args.img_dist_thres, relative_depth_diff < 0.01)
