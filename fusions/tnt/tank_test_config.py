...
# tank_cfg.Family.conf = [0.25, 0.3, 0.3, 0.3]
# tank_cfg.Francis.conf = [0.25, 0.3, 0.3, 0.0]
# tank_cfg.Horse.conf = [0.15, 0.15, 0.2, 0.2]
# tank_cfg.Lighthouse.conf = [0.25, 0.3, 0.4, 0.7]
# tank_cfg.M60.conf = [0.25, 0.3, 0.3, 0.6]
# tank_cfg.Panther.conf = [0.1, 0.25, 0.3, 0.6]
# tank_cfg.Playground.conf = [0.1, 0.2, 0.3, 0.7]
# tank_cfg.Train.conf = [0.2, 0.3, 0.3, 0.6]
# tank_cfg.Auditorium.conf = [0.05, 0.05, 0.1, 0.1]
# tank_cfg.Ballroom.conf = [0.1, 0.15, 0.2, 0.05]
# tank_cfg.Courtroom.conf = [0.1, 0.15, 0.2, 0.4]
# tank_cfg.Museum.conf = [0.1, 0.15, 0.25, 0.5]
# tank_cfg.Palace.conf = [0.1, 0.15, 0.25, 0.15]
# tank_cfg.Temple.conf = [0.1, 0.15, 0.2, 0.15]

# tank_cfg.Family.conf = [0.25, 0.3, 0.3, 0.3]
# tank_cfg.Francis.conf = [0.25, 0.3, 0.3, 0.2]
# tank_cfg.Horse.conf = [0.15, 0.15, 0.2, 0.]
# tank_cfg.Lighthouse.conf = [0.25, 0.3, 0.4, 0.7]
# tank_cfg.M60.conf = [0.25, 0.3, 0.3, 0.6]
# tank_cfg.Panther.conf = [0.1, 0.25, 0.3, 0.6]
# tank_cfg.Playground.conf = [0.1, 0.2, 0.3, 0.7]
# tank_cfg.Train.conf = [0.2, 0.3, 0.3, 0.6]
# tank_cfg.Auditorium.conf = [0.05, 0.05, 0.1, 0.0]
# tank_cfg.Ballroom.conf = [0.1, 0.15, 0.2, 0.4]
# tank_cfg.Courtroom.conf = [0.1, 0.15, 0.2, 0.4]
# tank_cfg.Museum.conf = [0.1, 0.15, 0.25, 0.5]
# tank_cfg.Palace.conf = [0.1, 0.15, 0.25, 0.5]
# tank_cfg.Temple.conf = [0.1, 0.15, 0.2, 0.2]

tank_cfg.Family.conf = [5, 5, 10, 10]
tank_cfg.Francis.conf = [5, 5, 10, 10]
tank_cfg.Horse.conf = [5, 5, 10, 10]
tank_cfg.Lighthouse.conf = [5, 10, 15, 20]
tank_cfg.M60.conf = [5, 10, 15, 20]
tank_cfg.Panther.conf = [5, 10, 15, 20]
tank_cfg.Playground.conf = [5, 10, 15, 20]
tank_cfg.Train.conf = [5, 10, 15, 20]
tank_cfg.Auditorium.conf = [5, 5, 5, 5]
tank_cfg.Ballroom.conf = [5, 10, 15, 20]
tank_cfg.Courtroom.conf = [5, 10, 15, 20]
tank_cfg.Museum.conf = [5, 10, 15, 20]
tank_cfg.Palace.conf = [5, 10, 15, 20]
tank_cfg.Temple.conf = [5, 10, 15, 20]
